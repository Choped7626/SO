...
void command (char *tr[] , tList *histComm , int* commNum , bool* fin , int* recursividad , tList *listOpen , tList *listmalloc , tList *listProcss , int argc , char *argv[] , char* env[]);
...
void whichCommand(char *tr[], tList *histComm , int* commNum , bool* fin , int* recursividad , tList *listOpen , tList *listmalloc , tList *listaProcss , int argc , char *argv[] , char *env[]);
void procesarEntrada(char c[] , bool *fin , tList *histComm , tList *listOpen , tList *listmalloc , tList *listaProcess , int argc , char *argv[] , char *env[]);
